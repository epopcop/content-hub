...
from cyware_intel_exchange.actions import manage_tags_in_iocs
from cyware_intel_exchange.tests.common import CONFIG_PATH, MOCK_ADD_TAGS, MOCK_BULK_LOOKUP
...
class TestManageTagsInIOCs:
    @set_metadata(
        integration_config_file_path=CONFIG_PATH,
        parameters=DEFAULT_PARAMETERS,
        entities=DEFAULT_ENTITIES,
    )
    def test_manage_tags_add_success(
        self,
        ...
        cyware.add_tags_response = MOCK_ADD_TAGS
        success_output_msg_prefix = "Successfully added"

        manage_tags_in_iocs.main()
