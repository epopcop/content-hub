...
from cyware_intel_exchange.actions import add_iocs_to_allowed_list
from cyware_intel_exchange.tests.common import CONFIG_PATH, MOCK_ADD_ALLOWED_IOCS, MOCK_BULK_LOOKUP
...
DEFAULT_PARAMETERS = {
    "IOC Type": "ipv4-addr",
    "Reason": "Test allowlist from integration tests",
}
...
class TestAddIOCsToAllowedList:
    @set_metadata(
        integration_config_file_path=CONFIG_PATH,
        parameters=DEFAULT_PARAMETERS,
        entities=DEFAULT_ENTITIES,
    )
    def test_add_iocs_to_allowed_list_success(
        self,
        ...
        cyware.add_allowed_iocs_response = MOCK_ADD_ALLOWED_IOCS
        success_output_msg_prefix = "Successfully processed"

        add_iocs_to_allowed_list.main()
